...
BAD_EMAIL = re.compile(r"(no-?reply|donotreply|example\.|@sentry|\.png|\.jpg|privacy@|abuse@|webmaster@|support@linkedin|@indeed|@linkedin)", re.I)
...
def collect(field, country, city, hours_old=48, results=25, log=print):
